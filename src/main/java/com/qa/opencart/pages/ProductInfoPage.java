...
public class ProductInfoPage {
		...
		public String getProductHeader() {
			String header =
			eleUtil.waitForElementVisible(productHeader, AppConstants.DEFAULT_TIMEOUT).getText();
		...
		public int getProductImagesCount() {
			int imageCount =
			eleUtil.waitForElementsVisible(productImages, AppConstants.DEFAULT_TIMEOUT).size();
			System.out.println("Total no. of product images are : "+ imageCount);
			return imageCount;
		}
